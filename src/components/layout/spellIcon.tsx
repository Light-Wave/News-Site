...
export default function SpellIcon({ children, color, tooltip, onClick }: { children: React.ReactNode; color: string; tooltip: string; onClick?: () => void }) {
    ...
    return (
      ...
      `}>
                <div className={`absolute inset-0 bg-gradient-to-t ${style.gradient} opacity-60 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity duration-500`} />
