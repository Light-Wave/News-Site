  ...
  return (
    <div className={cn("relative w-full overflow-hidden py-2", className)}>
      <div className="mx-auto flex w-full max-w-4xl items-center justify-center">
        ...
        <div className="relative z-20 h-10 w-6 sm:h-16 sm:w-8 shrink-0 rounded-l-sm border-r-2 border-[#5c4033] bg-[#8b5a2b] shadow-xl">
        ...
        <div className="relative z-10 flex h-10 sm:h-14 grow items-center overflow-hidden bg-[#f4e4bc] shadow-lg">
          <div
          ...
          <div className="flex w-full overflow-hidden whitespace-nowrap">
            <div className="animate-marquee inline-block py-1 sm:py-2 pl-[100%]">
              <span className="mx-2 sm:mx-4 text-sm sm:text-xl font-bold text-[#4a3728] font-cinzel tracking-widest uppercase">
                BREAKING NEWS: {text}
              </span>
            </div>
          </div>
        ...
        <div className="relative z-20 h-10 w-6 sm:h-16 sm:w-8 shrink-0 rounded-r-sm border-l-2 border-[#5c4033] bg-[#8b5a2b] shadow-xl">
          <div className="absolute inset-0 bg-gradient-to-r from-black/40 via-transparent to-black/40" />
